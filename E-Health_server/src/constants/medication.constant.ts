/**
 * Định nghĩa các mã lỗi cho module Medication Management (Nhóm thuốc)
 */
...
/**
 * Định nghĩa các mã lỗi cho module Medication Management (Từ điển thuốc - Drugs)
 */
...
/**
 * Các hằng số cấu hình dùng chung cho module Medication Management
 */
